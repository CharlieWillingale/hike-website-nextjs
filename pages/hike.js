...
export default function Home({allPostsData}) {
  ...
  var hike_posts = allPostsData.filter(post => post.category == 'hike')

  return (
    <>
      <Head>
        <title>Hike Site | Hike</title>
      </Head>
      <Showcase title={'Hike.'} />
      ...
      <main>
          ...
          <section className='flex flex-col lg:flex-row'>
            {hike_posts.slice(0,3).map(({ id, title,routeImageUrl,routeImageAlt,routeSampleText,routeDistance,routeElevation,routeDifficulty}) => (
